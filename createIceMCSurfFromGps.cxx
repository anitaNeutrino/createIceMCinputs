...
int main(int argc, char *argv[]){
  ...
  for (int run=firstRun;run<lastRun+1; run++){
    sprintf(surfName,"/unix/anita3/flight1415/root/run%d/surfHkFile%d.root",run,run);
  ...
  TFile *output = new TFile (Form("partial/SampleSurf_run%d_anita3.root", firstRun), "recreate");
